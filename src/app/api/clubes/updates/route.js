...
const updateClubesData = (clubesData, fechaData) => {
  fechaData.forEach(({ Local, Visitante, GolL, GolV }) => {
    ...
    if (localClub) {
      ...
      localClub.PE = parseInt(localClub.PE, 10);
      ...
      localClub.DG = parseInt(localClub.GF) - parseInt(localClub.GC);
      if (GolL > GolV) {
        localClub.PG += 1;
        localClub.puntos += 3;
      } else if (GolL < GolV) {
    ...
    if (visitanteClub) {
      ...
      visitanteClub.PJ = parseInt(visitanteClub.PJ, 10);
      visitanteClub.PG = parseInt(visitanteClub.PG, 10);
      visitanteClub.PE = parseInt(visitanteClub.PE, 10);
      ...
      visitanteClub.DG =
        parseInt(visitanteClub).GF - parseInt(visitanteClub.GC);
      if (GolV > GolL) {
        visitanteClub.PG += 1;
